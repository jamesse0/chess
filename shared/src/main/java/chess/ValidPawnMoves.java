...
public class ValidPawnMoves {
    public static List<ChessMove> validMoves
            (ChessPosition sPosition, ChessPiece thePiece, ChessBoard theBoard) {
        ...
        if (thePiece.getTeamColor() == ChessGame.TeamColor.WHITE) {
            if (sPosition.getRow() == 2) {
                if ((theBoard.getPiece((new ChessPosition(sPosition.getRow()+1, sPosition.getColumn() ))) == null)
                        && (theBoard.getPiece
                        ((new ChessPosition(sPosition.getRow()+2, sPosition.getColumn() ))) == null)) {
                    listValidMoves.add(new ChessMove(sPosition, new ChessPosition
                            (sPosition.getRow()+2, sPosition.getColumn()), null));
                }
            }
            if (sPosition.getRow() == 7) {
                if (theBoard.getPiece(new ChessPosition(sPosition.getRow()+1, sPosition.getColumn())) == null) {
                    listValidMoves.addAll(proMoves(sPosition, new ChessPosition
                            (sPosition.getRow()+1, sPosition.getColumn())));
                }
                if (sPosition.getColumn()+1 <= 8) {
                    ChessPiece otherPiece = theBoard.getPiece(new ChessPosition
                            (sPosition.getRow()+1, sPosition.getColumn()+1));
                ...
                if (theBoard.getPiece(new ChessPosition(sPosition.getRow()+1, sPosition.getColumn())) == null) {
                    listValidMoves.add(new ChessMove(sPosition, new ChessPosition
                            (sPosition.getRow()+1, sPosition.getColumn()), null));
                }
                if (sPosition.getColumn()+1 <= 8) {
                    ChessPiece otherPiece = theBoard.getPiece(new ChessPosition
                            (sPosition.getRow()+1, sPosition.getColumn()+1));
                    if ((otherPiece != null) && (otherPiece.getTeamColor() == ChessGame.TeamColor.BLACK)) {
                        listValidMoves.add(new ChessMove(sPosition, new ChessPosition
                                (sPosition.getRow()+1, sPosition.getColumn()+1), null));
                    }
                }
                if (sPosition.getColumn()-1 >= 1) {
                    ChessPiece otherPiece = theBoard.getPiece(new ChessPosition
            ...
            if (sPosition.getRow() == 7) {
                if ((theBoard.getPiece((new ChessPosition(sPosition.getRow()-1, sPosition.getColumn() ))) == null)
                        && (theBoard.getPiece((new ChessPosition
                        (sPosition.getRow()-2, sPosition.getColumn() ))) == null)) {
                    listValidMoves.add(new ChessMove(sPosition, new ChessPosition
                            (sPosition.getRow()-2, sPosition.getColumn()), null));
                }
    ...
    public static List<ChessMove> proMoves
            (ChessPosition sPosition, ChessPosition endPosition){ //if it is a promotion move this returns a ChessMove list of all promotion moves
